...
namespace DashTest\Mvc\Router\Http\Route;

use Dash\Mvc\Router\Http\Parser\ParseResult;
use Dash\Mvc\Router\Http\Route\Generic;
...
/**
 * @covers Dash\Mvc\Router\Http\Route\Generic
 */
class GenericTest extends TestCase
{
    ...
    {
        $pathParser = $this->getMock('Dash\Mvc\Router\Http\Parser\ParserInterface');
        $pathParser
            ->expects($this->once())
            ->method('parse')
    ...
    {
        $hostnameParser = $this->getMock('Dash\Mvc\Router\Http\Parser\ParserInterface');
        $hostnameParser
            ->expects($this->once())
            ->method('parse')
    ...
    public function testIncompletePathMatchWithChildMatch()
    {
        ...
        $childRoute = $this->getMock('Dash\Mvc\Router\Http\Route\RouteInterface');
        $childRoute
            ->expects($this->once())
            ->method('match')
    ...
    /**
     * @return \Dash\Mvc\Router\Http\Parser\ParserInterface||\PHPUnit_Framework_MockObject_MockObject
     */

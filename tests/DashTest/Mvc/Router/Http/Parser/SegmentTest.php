...
namespace DashTest\Mvc\Router\Http\Parser;

use Dash\Mvc\Router\Http\Parser\Segment;
use PHPUnit_Framework_TestCase as TestCase;

/**
 * @covers Dash\Mvc\Router\Http\Parser\Segment
 */
class SegmentTest extends TestCase
{
    ...
    public function parseExceptionsProvider()
    {
        return [
            'unbalanced-brackets' => [
                '[',
                'Dash\Mvc\Router\Exception\RuntimeException',
    ...
    public function testParsing(Segment $route, $input, $offset = 0, array $params = null)
    {
        ...
        if ($params === null) {
            ...
            $this->assertInstanceOf('Dash\Mvc\Router\Http\Parser\ParseResult', $result);
    ...
    {
        $this->setExpectedException('Dash\Mvc\Router\Exception\InvalidArgumentException', 'Missing parameter "foo"');
